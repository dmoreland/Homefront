// Shared inline-style objects for the Ministry-of-Information poster look.
export const S = {
  ...
  card: { border: "1px solid #33506E", borderRadius: 10, overflow: "hidden", color: "#EDE6D3" },
  subBtn: { border: "none", borderTop: "1px solid #33506E", padding: "8px 0", fontWeight: 700, fontSize: 12, letterSpacing: 1 },
};
