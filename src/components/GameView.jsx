  ...
  return (
    <div style={{ minHeight: "100vh", background: "#16222E", color: "#EDE6D3", fontFamily: "'Trebuchet MS','Segoe UI',sans-serif", paddingBottom: 32 }}>
      ...
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "0 14px" }}>
        ...
        <Theatres nation={nation} stages={game.stages} missions={game.missions} forces={game.forces} readiness={game.readiness} garrison={game.garrison} pressure={game.pressure} upgrades={game.upgrades} mods={mods} fuelStarved={fuelStarved} now={now} onLaunch={actions.launch} onGarrison={actions.garrison} onWithdraw={actions.withdraw} />
